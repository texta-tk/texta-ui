...
export class ReindexerService {
  ...
  getReindexers(projectId: number, params = ''): Observable<ResultsWrapper<Reindexer> | HttpErrorResponse> {
    return this.http.get<ResultsWrapper<Reindexer>>(`${this.apiUrl}/projects/${projectId}/elastic/reindexer/?${params}`).pipe(
  ...
  createReindexer(body: unknown, projectId: number): Observable<Reindexer | HttpErrorResponse> {
    return this.http.post<Reindexer>(`${this.apiUrl}/projects/${projectId}/elastic/reindexer/`, body).pipe(
  ...
  bulkDeleteReindexers(projectId: number, body: unknown): Observable<unknown> {
    ...
    (`${this.apiUrl}/projects/${projectId}/elastic/reindexer/bulk_delete/`, body).pipe(
  ...
  deleteReindex(reindexerId: number, projectId: number): Observable<unknown> {
    return this.http.delete(`${this.apiUrl}/projects/${projectId}/elastic/reindexer/${reindexerId}/`).pipe(
  ...
  getReindexerOptions(projectId: number): Observable<unknown> {
    return this.http.options<unknown>(`${this.apiUrl}/projects/${projectId}/elastic/reindexer/`).pipe(
