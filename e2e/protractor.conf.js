        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, protractor_1.browser.driver.get('http://localhost:4200/')];
                case 1:
                    _a.sent(); // todo, default? env file!
                    return [4 /*yield*/, protractor_1.browser.driver.findElement(protractor_1.by.id('loginButton'))];
                case 2:
                    login = _a.sent();
                    login.click();
